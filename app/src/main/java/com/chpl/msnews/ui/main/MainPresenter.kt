...
import com.chpl.msnews.ui.base.BasePresenter
...
@Inject constructor(
    ...
    fun onSearchClicked() {
        ...
        val paramAccount = signInAccount?.email
        viewState.openNewsScreen(paramKeywords, paramCategories, paramCountries, paramAccount)
    }
